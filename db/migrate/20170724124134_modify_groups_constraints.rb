class ModifyGroupsConstraints < ActiveRecord::Migration[5.0]
  def up
    ...
    execute <<-SQL
      ...
      alter table groups add constraint starts_at_is_today_or_later CHECK(starts_at AT TIME ZONE 'UTC' >= current_timestamp)
    SQL
